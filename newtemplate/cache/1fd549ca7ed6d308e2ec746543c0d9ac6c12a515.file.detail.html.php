<?php /* Smarty version Smarty-3.1.15, created on 2015-04-01 16:25:06
         compiled from "app/view/paket/detail.html" */ ?>
<?php /*%%SmartyHeaderCode:1585986713551bb73f792069-62140046%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1fd549ca7ed6d308e2ec746543c0d9ac6c12a515' => 
    array (
      0 => 'app/view/paket/detail.html',
      1 => 1427880304,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1585986713551bb73f792069-62140046',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.15',
  'unifunc' => 'content_551bb73f7d4314_81762686',
  'variables' => 
  array (
    'basedomain' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_551bb73f7d4314_81762686')) {function content_551bb73f7d4314_81762686($_smarty_tpl) {?><link rel="stylesheet" href="<?php echo $_smarty_tpl->tpl_vars['basedomain']->value;?>
assets/css/etalage.css">
<script src="<?php echo $_smarty_tpl->tpl_vars['basedomain']->value;?>
assets/js/jquery.etalage.min.js"></script>
<script>
						...
						<ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image img-responsive" src="<?php echo $_smarty_tpl->tpl_vars['basedomain']->value;?>
assets/img/sin1.jpg" alt="" >
									<img class="etalage_source_image img-responsive" src="<?php echo $_smarty_tpl->tpl_vars['basedomain']->value;?>
assets/img/sin-1.jpg" alt="" >
								</a>
							</li>
							<li>
								<img class="etalage_thumb_image img-responsive" src="<?php echo $_smarty_tpl->tpl_vars['basedomain']->value;?>
assets/img/sin2.jpg" alt="" >
								<img class="etalage_source_image img-responsive" src="<?php echo $_smarty_tpl->tpl_vars['basedomain']->value;?>
assets/img/sin-2.jpg" alt="" >
							</li>
							<li>
								<img class="etalage_thumb_image img-responsive" src="<?php echo $_smarty_tpl->tpl_vars['basedomain']->value;?>
assets/img/sin3.jpg" alt=""  >
								<img class="etalage_source_image img-responsive" src="<?php echo $_smarty_tpl->tpl_vars['basedomain']->value;?>
assets/img/sin-3.jpg" alt="" >
							</li>
						    <li>
								<img class="etalage_thumb_image img-responsive" src="<?php echo $_smarty_tpl->tpl_vars['basedomain']->value;?>
assets/img/sin4.jpg"  alt="" >
								<img class="etalage_source_image img-responsive" src="<?php echo $_smarty_tpl->tpl_vars['basedomain']->value;?>
assets/img/sin-4.jpg" alt="" >
							</li>
						</ul>
				  ...
				  <div class="desc1">
					...
					<div class="share-desc">
						<div class="share">
							<h4>Share Product :</h4>
							<ul class="share_nav">
								<li><a href="#"><img src="<?php echo $_smarty_tpl->tpl_vars['basedomain']->value;?>
assets/img/facebook.png" title="facebook"></a></li>
								<li><a href="#"><img src="<?php echo $_smarty_tpl->tpl_vars['basedomain']->value;?>
assets/img/twitter.png" title="Twiiter"></a></li>
								<li><a href="#"><img src="<?php echo $_smarty_tpl->tpl_vars['basedomain']->value;?>
assets/img/rss.png" title="Rss"></a></li>
								<li><a href="#"><img src="<?php echo $_smarty_tpl->tpl_vars['basedomain']->value;?>
assets/img/gpluse.png" title="Google+"></a></li>
				    		</ul>
						</div>
						<div class="clearfix"></div>
					</div>
		...
		<div class="sap_tabs">	
					 ...
					 <script src="<?php echo $_smarty_tpl->tpl_vars['basedomain']->value;?>
assets/js/easyResponsiveTabs.js" type="text/javascript"></script>
