...
$CONFIG['default']['base_url'] = 'http://localhost/lelangbusana/newtemplate/';
$CONFIG['default']['root_path'] = $_SERVER['DOCUMENT_ROOT'].'/lelangbusana/newtemplate';

$CONFIG['default']['upload_path'] = $_SERVER['DOCUMENT_ROOT'].'/lelangbusana/newtemplate/public_assets/';
