<?php /* Smarty version Smarty-3.1.15, created on 2015-03-31 13:57:24
...
<?php if ($_valid && !is_callable('content_543dec622778c6_55811008')) {function content_543dec622778c6_55811008($_smarty_tpl) {?>
<!--NAVBAR-->
<!--===================================================-->
<header id="navbar">
	<div id="navbar-container" class="boxed">
		...
		<div class="navbar-header">
			<a href="index.html" class="navbar-brand">
				<img src="images/logo.png" alt="Logo" class="brand-icon">
				<div class="brand-title">
					<span class="brand-text">Lelang Busana</span>
				</div>
			</a>
		</div>
		<!--================================-->
				...
				<li id="dropdown-user" class="dropdown">
					<a href="#" data-toggle="dropdown" class="dropdown-toggle text-right">
						<span class="pull-right">
							<img class="img-circle img-user media-object" src="images/ava/av1.png" alt="Profile Picture">
						</span>
						<div class="username hidden-xs"><?php echo $_smarty_tpl->tpl_vars['admin']->value['admin']['name'];?>
</div>
					</a>
